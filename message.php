<?php
	...
	//写短信
	if(isset($_GET['action']) && ($_GET['action'] == 'write') && isset($_POST['code'])){
      	...
      	<h3>写短信</h3>
            ...
            <dl>
            	<dd><input type="text" readonly="readonly" class="text" value="To：<?php echo $_html['touser'];?>"/></dd>
                  ...
                  <dd>验 证 码：<input type="text" name="code" class="text yzm"/><img id="code" src="code.php" /><input type="submit" class="submit" value="发送短信"/></dd>
            </dl>
            </form>
      </div>
